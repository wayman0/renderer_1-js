   ...
   */
   #sub(n, v0, v1, v2, sierpinski)
   {
      ...
      if (0 == n)
      {
         ...
         this.addPrimitive(LineSegment.buildVertex(index+0, index+1),  // v0, v1
                           LineSegment.buildVertex(index+1, index+2),  // v1, v2
                           LineSegment.buildVertex(index+2, index+0)); // v2, v0
      }
      else
      {
