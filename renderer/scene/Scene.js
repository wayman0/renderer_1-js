...
//@ts-check
import {Camera, Model, Position, Vertex, LineSegment} from "./SceneExports.js";
...
export default class Scene
{
     ...
     * @param {Camera} cam the camera to replace this scenes camera with 
     * @returns {Scene} this scene with the updated camera
     */
    changeCamera(cam)
    {
        if(cam instanceof Camera == false)
            throw new Error("Cam must be a Camera");
    ...
    static main()
    {
        ...
        line.addVertex(new Vertex(-1, 0, 0),
                        new Vertex(1, 0, 0));
        line.addPrimitive(LineSegment.buildVertex(0, 1));
        ...
        */
        ...
        const scene1Copy = scene1.changeCamera(cam);
        console.log(scene1.toString());
        console.log(scene1Copy.toString());
